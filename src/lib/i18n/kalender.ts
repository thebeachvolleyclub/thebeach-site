...
export const kalenderDict: Dict<KalenderDict> = {
  sv: {
      ...
      items: [
        {
          ...
          body: "Två säsonger per år: Sommarsäsong (måndagar & onsdagar, maj–början av juli, 7 pass) och Höstsäsong (söndagar, måndagar & onsdagar, sena augusti–december, 15 pass). Anmälan öppnar inför varje säsong — efterfrågan är hög och platserna brukar fyllas snabbt.",
          note: "Frågor om träning: trana@thebeach.one",
    ...
    seasons: {
      ...
      title1: "Sommar &",
      title2: "höst",
      lead1: "Träningsgrupperna löper i säsonger. Anmälan öppnar ",
      leadStrong: "inför varje säsong",
  ...
  en: {
      ...
      items: [
        {
          ...
          body: "Two seasons per year: the Summer season (Mondays & Wednesdays, May–early July, 7 sessions) and the Autumn season (Sundays, Mondays & Wednesdays, late August–December, 15 sessions). Registration opens ahead of each season — demand is high and spots tend to fill up fast.",
          note: "Questions about training: trana@thebeach.one",
    ...
    seasons: {
      ...
      title1: "Summer &",
      title2: "autumn",
      lead1: "The training groups run in seasons. Registration opens ",
      leadStrong: "ahead of each season",
