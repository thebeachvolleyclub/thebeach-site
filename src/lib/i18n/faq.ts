...
export const faqDict: Dict<FaqDict> = {
  sv: {
    ...
    items: [
      ...
      { q: "Hur tar jag mig hit?", a: "Novavägen 35, 141 44 Huddinge. Pendeltåg till Huddinge centrum med anslutningsbuss linje 714 eller 742 till närmaste busshållplats Midsommarvägen, eller pendeltåget till Flemingsberg och kort promenad, eller bil — det finns gott om parkering direkt vid hallen samt gratis parkering efter Novavägen (kom ihåg P-skiva)." },
      ...
      { q: "Kan barn spela hos er?", a: "Ja — vi har barn- och ungdomsträning, barnkalas (6–11 år), Teneriffa för ungdomslag och tar emot skolklasser på vardagar. Se sidorna [Barnkalas](/barnkalas), [Teneriffa](/teneriffa) och [Skolor](/skola)." },
      { q: "Hur avbokar jag träning eller kurs?", a: "Det beror på vad du vill avboka. Kurs (grund- eller fortsättningskurs): mejla boka@thebeach.one så snart du kan — kan din plats fyllas av någon annan får du behålla värdet tillgodo till nästa kursstart, och avbokar du i god tid innan kursen börjar krediterar vi dig. Träningsgrupp: då gäller villkoren du godkände i anmälan — läs [avanmälan & villkor](/avanmalan) och gör din avanmälan via formuläret där. Banbokning: avbokas under Mina bokningar på boka-sidan eller i appen — full återbetalning inom en timme efter bokningen, därefter återbetalas beloppet minus 20 kr fram till 24 timmar före start." },
      { q: "Jag är med i en träningsgrupp och är inte nöjd med gruppen. Hur går jag vidare?", a: "Skicka en ändringsförfrågan i appen så jobbar vi på saken så snabbt vi kan: Profil → Inställningar → Allmänt → Ändringsförfrågan. Känner du dig fel placerad nivåmässigt — prata först med din tränare efter passet och hör vad de tycker. Undvik att mejla bokningen eller hälsa via receptionen; det blir lätt missförstånd. Du behåller din plats tills något annat bestämts och meddelats skriftligt." },
    ],
  },
  en: {
    meta: {
    ...
    items: [
      ...
      { q: "How do I get there?", a: "Novavägen 35, 141 44 Huddinge. Commuter train to Huddinge centrum with connecting bus 714 or 742 to the Midsommarvägen stop, or commuter train to Flemingsberg and a short walk — or by car, with plenty of parking right by the hall plus free parking along Novavägen (remember your parking disc)." },
      ...
      { q: "Can children play?", a: "Yes — we run kids' and youth training, kids' parties (ages 6–11), Teneriffa for youth teams and welcome school classes on weekdays. See [Kids' party](/en/kids-party), [Teneriffa](/en/tenerife) and [Schools](/en/school)." },
      { q: "How do I cancel training or a course?", a: "It depends what you want to cancel. Course (beginner or intermediate): email boka@thebeach.one as soon as you can — if your spot can be filled by someone else you keep the value as credit for the next course, and if you cancel in good time before it begins we credit you. Training group: the terms you accepted at registration apply — read [cancellation & terms](/avanmalan) and cancel via the form there. Court booking: cancel under My bookings on the booking page or in the app — full refund within one hour of booking, after that the amount minus 20 kr is refunded up to 24 hours before start." },
      { q: "I'm in a training group and not happy with it. What do I do?", a: "Send a change request in the app and we'll work on it as fast as we can: Profil → Inställningar → Allmänt → Ändringsförfrågan. If you feel you're placed at the wrong level, talk to your coach after practice first. Avoid emailing the front desk or mentioning it in passing — it easily leads to misunderstandings. You keep your spot until something else is decided and confirmed in writing." },
    ],
  },
};
