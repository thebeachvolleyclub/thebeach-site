  ...
  sv: {
    ...
    training: {
      ...
      cards: [
        ...
        { level: "Avancerat", title: "Träningsgrupper", when: "Höstsäsong · Start 30 aug", desc: "Jämna grupper på din nivå — träning med coacher på nationell nivå.", badge: "Se aktuell anmälningsstatus", spots: "few", href: "/trana#traningsgrupper" },
      ...
      ctaKicker: "Kurserna: öppna nu · Grupperna: se aktuell status",
  ...
  en: {
    ...
    training: {
      ...
      cards: [
        ...
        { level: "Advanced", title: "Training groups", when: "Autumn season · Starts 30 Aug", desc: "Balanced groups at your level — training with coaches at national level.", badge: "See current registration status", spots: "few", href: "/trana#traningsgrupper" },
      ...
      ctaKicker: "Courses: open now · Groups: see current status",
