...
export const homeDict: Dict<HomeDict> = {
  sv: {
    ...
    training: {
      ...
      cards: [
        { level: "Nybörjare", title: "Grundkurs", when: "Start 1 sep & 3 sep · 5 pass · 795 kr", desc: "Spela, träna och lär känna sporten från grunden.", badge: "Platser kvar", spots: "open", href: "/trana#kurser" },
        { level: "Mellannivå", title: "Fortsättningskurs", when: "Start 1 sep & 3 sep · 15 pass · hela hösten", desc: "Du kan grunderna — nu tar vi ditt spel till nästa nivå.", badge: "Platser kvar", spots: "open", href: "/trana#kurser" },
        { level: "Avancerat", title: "Träningsgrupper", when: "Höstsäsong · Start 30 aug", desc: "Jämna grupper på din nivå — träning med coacher på nationell nivå.", badge: "Anmälan stängd", spots: "few", href: "/trana#traningsgrupper" },
      ...
      ctaKicker: "Säsongen startar 30 aug · platser kvar i kurserna",
  ...
  en: {
    ...
    training: {
      ...
      cards: [
        { level: "Beginner", title: "Beginner course", when: "Starts 1 & 3 Sep · 5 sessions · 795 kr", desc: "Play, train and get to know the sport from the ground up.", badge: "Places left", spots: "open", href: "/trana#kurser" },
        { level: "Intermediate", title: "Continuation course", when: "Starts 1 & 3 Sep · 15 sessions · all autumn", desc: "You know the basics — now we take your game to the next level.", badge: "Places left", spots: "open", href: "/trana#kurser" },
        { level: "Advanced", title: "Training groups", when: "Autumn season · Starts 30 Aug", desc: "Balanced groups at your level — training with coaches at national level.", badge: "Registration closed", spots: "few", href: "/trana#traningsgrupper" },
      ...
      ctaKicker: "Season starts 30 Aug · places left on the courses",
