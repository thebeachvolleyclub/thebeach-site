...
export const FILMER: Film[] = [
  ...
  { fil: V + "entre-lounge-passage.mp4", poster: V + "entre-lounge-passage.webp", titel: "Våra stålvajrar som följer ramarna in i sandlådorna går att använda till praktiska funktioner — här för give-aways", yta: ["entre","lounge"], typ: ["fest"], format: "liggande" },
  { fil: V + "lounge-mingel.mp4", poster: V + "lounge-mingel.webp", titel: "Mingel runt baren", yta: ["lounge","bar"], typ: ["fest","kickoff"], format: "liggande" },
  ...
  { fil: V + "bar-plockmat.mp4", poster: V + "bar-plockmat.webp", titel: "Plockmat runt baren och filmvisning där vi normalt har bana 4", yta: ["bar","sandplan-b"], typ: ["fest","kickoff","julbord"], format: "liggande" },
  ...
  { fil: V + "b-livemusik-oktagon.mp4", poster: V + "b-livemusik-oktagon.webp", titel: "Las Ketchup gjorde succé på scenen där vi normalt har bana 4", yta: ["sandplan-b"], typ: ["fest","massa"], format: "liggande" },
  ...
  { fil: V + "b-klipp-4.mp4", poster: V + "b-klipp-4.webp", titel: "Dans i sanden är roligare", yta: ["sandplan-b"], typ: ["fest"], format: "staende" },
  { fil: V + "b-klipp-5.mp4", poster: V + "b-klipp-5.webp", titel: "DJ vid bana 3", yta: ["sandplan-b"], typ: ["fest"], format: "staende" },
  ...
  { fil: V + "c-klipp-1.mp4", poster: V + "c-klipp-1.webp", titel: "Eldshow i loungen", yta: ["lounge"], typ: ["fest"], format: "staende" },
  { fil: V + "c-klipp-2.mp4", poster: V + "c-klipp-2.webp", titel: "Saxofondisko för de sista kvarvarande gästerna vid stängning", yta: ["sandplan-c"], typ: ["fest"], format: "staende" },
