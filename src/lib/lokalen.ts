...
export const BILDER: Bild[] = [
  ...
  { fil: NY + "b-dukning-langbord.webp", alt: "Långbord dukat för middag med ljus längs hela raden", yta: ["sandplan-b"], typ: ["fest", "julbord", "brollop"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "b-livemusik.webp", alt: "Liveartister på scenen under ett kvällsevent", yta: ["sandplan-b"], typ: ["fest"], format: "staende", prio: 2 },
  ...
  { fil: NY + "b-palmer-mot-lounge.webp", alt: "Palmer och solnedgångsvägg sedda mot loungen", yta: ["sandplan-b"], typ: ["fest", "kickoff"], format: "staende", prio: 2 },
  ...
  { fil: NY + "bar-cavatorn.webp", alt: "Champagnetorn i baren", yta: ["bar"], typ: ["fest", "brollop"], format: "staende", prio: 1 },
  { fil: NY + "bar-drinkar.webp", alt: "Drinkar färdiga för servering", yta: ["bar"], typ: ["fest"], format: "staende", prio: 2 },
  { fil: NY + "bar-mingel.webp", alt: "Mingel vid baren under företagsevent", yta: ["bar"], typ: ["fest", "kickoff"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "c-aktivitet-dagsljus.webp", alt: "Gruppaktivitet i sanden framför solnedgångsväggen", yta: ["sandplan-c"], typ: ["kickoff", "turnering"], format: "staende", prio: 1 },
  { fil: NY + "c-buffe-2.webp", alt: "Gäster vid buffén", yta: ["sandplan-c"], typ: ["fest", "julbord"], format: "liggande", prio: 2 },
  { fil: NY + "c-buffe.webp", alt: "Buffé serverad under kvällsevent", yta: ["sandplan-c"], typ: ["fest", "julbord"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "c-eldshow.webp", alt: "Eldshow i sanden framför publiken", yta: ["sandplan-c"], typ: ["fest"], format: "staende", prio: 1 },
  ...
  { fil: NY + "c-gruppbild.webp", alt: "Stor gruppbild i sanden framför solnedgångsväggen", yta: ["sandplan-c"], typ: ["kickoff", "konferens"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "c-scen-band.webp", alt: "Band på scenen under kvällsevent", yta: ["sandplan-c"], typ: ["fest"], format: "liggande", prio: 2 },
  { fil: NY + "c-scen-kundlogga.webp", alt: "Scenen med kundens logotyp på solnedgångsväggen", yta: ["sandplan-c"], typ: ["kickoff", "fest", "massa"], format: "staende", prio: 1 },
  { fil: NY + "c-scen-livemusik.webp", alt: "Liveband på scenen med publik i sanden", yta: ["sandplan-c"], typ: ["fest"], format: "liggande", prio: 1 },
  { fil: NY + "c-scen-publik.webp", alt: "Publikhav med händerna i luften framför scenen", yta: ["sandplan-c"], typ: ["fest"], format: "liggande", prio: 1 },
  { fil: NY + "c-scen-pyro.webp", alt: "Scen med pyroteknik och jublande publik", yta: ["sandplan-c"], typ: ["fest"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "fac-dusch.webp", alt: "Duschrum med sju duschplatser", yta: ["faciliteter"], typ: ["konferens", "turnering"], format: "staende", prio: 1 },
  ...
  { fil: NY + "fac-roda-salongen.webp", alt: "Den röda salongen intill omklädningsrummen", yta: ["faciliteter"], typ: ["fest", "brollop"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "fac-toaletter.webp", alt: "Toalettrummet med sex unisextoaletter", yta: ["faciliteter"], typ: ["konferens", "fest"], format: "staende", prio: 1 },
  ...
  { fil: NY + "lounge-marmorbord.webp", alt: "Marmorbord dukat i loungen", yta: ["lounge"], typ: ["fest", "konferens"], format: "liggande", prio: 1 },
  { fil: NY + "lounge-mingel-sittande.webp", alt: "Sittande mingel i loungen i dagsljus", yta: ["lounge"], typ: ["konferens", "kickoff"], format: "staende", prio: 1 },
  { fil: NY + "lounge-mingel.webp", alt: "Mingel i loungen", yta: ["lounge"], typ: ["fest", "kickoff", "massa"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "ute-banor.webp", alt: "Utebanorna en sommardag", yta: ["utebanor"], typ: ["turnering", "kickoff"], format: "liggande", prio: 1 },
  ...
  { fil: NY + "ute-turnering.webp", alt: "Turnering på utebanorna med publik", yta: ["utebanor"], typ: ["turnering", "kickoff"], format: "liggande", prio: 1 },
];
