              ...
              {ev.appCta && (
                <div className="mt-8 flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex cursor-pointer items-center gap-2 bg-black px-8 py-4 text-xs font-bold uppercase tracking-[0.08em] text-lime transition-opacity hover:opacity-90"
                  >
