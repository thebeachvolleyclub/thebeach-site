...
export const metadata: Metadata = {
  ...
  openGraph: og("/events/privat", "Planera er fest — The Beach", "Lördagsfest på en inomhusstrand mitt i Stockholm — bygg festen steg för steg och se priset direkt, ink moms."),
};
