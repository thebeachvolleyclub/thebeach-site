...
export default function TeambuildingPage() {
  return (
    <CorporateLanding
      ...
      lead="Inget svetsar ihop ett team som att kämpa, skratta och heja fram varandra i sanden. Instruktörsledd beachvolley som funkar för alla nivåer — nybörjare som vana — kombinerat med mat och dryck. Och eftersom vi är inomhus med 25°C är det lika bra i januari som i juli."
      included={[
