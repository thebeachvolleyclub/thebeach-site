...
export default function BokaPage() {
  return <>
    ...
    <main className="flex-1">
      <PageHero minH="min-h-[52svh]" eyebrow="Boka bana" title={<>Din bana.<br /><span className="italic-accent">Din tid.</span></>} intro="Boka direkt hos The Beach. Du ser aktuellt pris för varje ledig tid och betalar smidigt med Swish." cta={<a href="#bokning" className="inline-flex cursor-pointer items-center gap-2 bg-lime px-9 py-4 text-xs font-bold uppercase tracking-[0.08em] text-black transition-colors hover:bg-lime-bright">Se lediga tider <span aria-hidden="true">↓</span></a>} />
