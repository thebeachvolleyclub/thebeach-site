...
export default function ConferenceBand() {
  return (
        ...
        <div className="flex flex-col items-start gap-4 bg-mint p-7 sm:flex-row sm:items-center sm:justify-between sm:gap-8 lg:p-11">
          <div>
            ...
            <p className="max-w-xl text-sm leading-snug text-black/55">
              Lägg till upp till 3 h konferens med projektor, duk och
              konferensyta i loungen. Passar samtliga eventkoncept — mötet på
              förmiddagen, spel och mat på eftermiddagen.
            </p>
          </div>
