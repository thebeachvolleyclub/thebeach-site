...
/** Training section med foto-tile i griddet. Texter ur startsidans ordbok.
 *  OBS: /trana saknar engelsk rutt — länkarna är svenska även på /en. */
export default function Training({ locale = "sv" }: { locale?: Locale }) {
  const t = homeDict[locale].training;
  return (
