...
export default function OmOssHero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Eyebrow — .eyebrow hard-codes lime, readable on dark bg here */}
        ...
        >
          <div>
            <p className="max-w-md text-[0.95rem] leading-relaxed text-bone/55">
              Beachvolley och strandevent året runt. Alla är välkomna.
            </p>
          </div>

          {/* Secondary scroll link — mirrors KalenderHero / TranaHero pattern */}
          <div className="flex shrink-0 flex-col items-start gap-3 sm:items-end">
            ...
            >
              Se anläggningen <span aria-hidden="true">↓</span>
            </Link>
          </div>
        </motion.div>
      </motion.div>
