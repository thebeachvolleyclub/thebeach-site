/** MOCKUP — photo-tile version of QuickNav. Four quick links over full-bleed photos. */
const ITEMS = [
  ...
  { n: "03", title: "Boka Event", href: "#event", img: "/media/event.webp", alt: "Event på The Beach" },
  { n: "04", title: "Tävla", href: "#calendar", img: "/media/vm-silver.webp", alt: "Tävling — VM-silver" },
];

export default function PhotoQuickNav() {
  return (
