  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-2xl items-center px-5 py-20">
      <section className="w-full border-2 border-lime bg-white p-8 text-black sm:p-12">
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.16em] text-black/45">{paid ? "Betalning registrerad" : "Betalning mottagen"}</p>
        <h1 className="mt-2 font-display text-4xl">{paid ? "Betalt och bokat" : closed ? "Betalningen kunde inte bekräftas" : "Vi bekräftar betalningen"}</h1>
